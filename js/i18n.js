...
(function () {
  ...
  var T = {
    ko: {
      ...
      'cargo.hero.note': '데이터: 선사 운송 추적(ONE·COSCO 실조회, 그 외 딥링크) + 관세청 유니패스 화물통관진행정보 OpenAPI · 항공 수입은 AWB 번호를 MBL로 조회',
      'cargo.trace.btn': '조회',
    ...
    en: {
      ...
      'cargo.hero.note': 'Data: carrier transport tracking (live for ONE/COSCO, deep links otherwise) + Korea Customs UNIPASS cargo-clearance OpenAPI · Air imports are searched as MBL by AWB number',
    ...
    zh: {
      ...
      'cargo.hero.note': '数据：船公司运输追踪（ONE/COSCO 实时查询，其余深链接）+ 韩国海关 UNIPASS 货物通关 OpenAPI · 空运进口以 AWB 作为 MBL 查询',
      'cargo.trace.btn': '查询',
