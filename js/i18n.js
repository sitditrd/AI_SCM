...
(function () {
  ...
  var T = {
    ko: {
      ...
      /* --- 화물 추적 (cargo.html) --- */
      'cargo.hero.title': '화물 추적 <span style="font-weight:300; opacity:.75;">— 해상·항공 수입 통관 진행</span>',
      'cargo.hero.sub': 'MBL / HBL / AWB 번호로 관세청 통관 진행 상태를 조회합니다',
      'cargo.hero.note': '데이터: 관세청 유니패스 화물통관진행정보 OpenAPI · 항공 수입은 AWB 번호를 MBL로 조회 · 수출/환적은 미지원',
      'cargo.trace.btn': '조회',
    ...
    en: {
      ...
      'status.sec04.hint': 'Latest 14 records',
      ...
      'cargo.hero.title': 'Cargo Tracking <span style="font-weight:300; opacity:.75;">— Ocean & Air Import Clearance Progress</span>',
      'cargo.hero.sub': 'Search Korea Customs clearance progress by MBL / HBL / AWB number',
      'cargo.hero.note': 'Data: Korea Customs UNIPASS cargo-clearance OpenAPI · Air imports are searched as MBL by AWB number · Export/transshipment not supported',
    ...
    zh: {
      ...
      /* --- 货物追踪 (cargo.html) --- */
      'cargo.hero.title': '货物追踪 <span style="font-weight:300; opacity:.75;">— 海运/空运进口通关进度</span>',
      'cargo.hero.sub': '通过 MBL / HBL / AWB 号码查询韩国海关通关进度',
      'cargo.hero.note': '数据：韩国海关 UNIPASS 货物通关 OpenAPI · 空运进口以 AWB 作为 MBL 查询 · 暂不支持出口/转运',
      'cargo.trace.btn': '查询',
